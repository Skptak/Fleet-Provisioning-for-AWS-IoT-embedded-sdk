...
function(create_test_binary_target test_name test_src link_list dep_list
         include_list)
  include(CTest)
  ...
  add_custom_command(
    ...
    COMMAND
      ...
      ${MODULE_ROOT_DIR}/tools/unity/project.yml ${test_src_absolute}
      ${test_name}_runner.c
    DEPENDS ${test_src})
...
function(create_library_target target_name src_file include_list)
